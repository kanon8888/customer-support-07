  ...
  return (
    <div className="bg-gray-100 w-full py-10">
      ...
      <div className="max-w-[1250px] mx-auto flex flex-col md:flex-row gap-6">
              ...
              >
                <div className="flex justify-between items-center mb-3">
                  ...
                  <div className={`flex items-center gap-2 rounded-full w-[120px] h-[28px] px-2
                    ...
                    <img
                      src={ticket.status === "Open" ? "image/Ellipse 22.png" : "image/Ellipse 22 (1).png"}
                      alt=""
                      className="w-4 h-4"
                    />
                ...
                <div className="flex justify-between items-center text-sm text-gray-500 mt-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <img src="image/ri_calendar-line.png" alt="" className="w-4 h-4" />
        ...
        {/* Task Status */}
        <div className="w-full md:w-[340px] rounded-lg shadow-md p-6 bg-white">
